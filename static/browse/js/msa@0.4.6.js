...
module.exports = boneView.extend({
  ...
  draw: function() {
    ...
    //Here the seqlogo starts to be calculated, ALEXEY
      window.seqlogoflag=true; //ALEXEY
    ...
    } else {window.seqlogoflag=false;} //ALEXEY
...
module.exports = view.extend({
  ...
  draw: function() {
    ...
    //here the logo is calculated, ALEXEY
...
stat.prototype.frequencyCalc = function frequencyCalc(opts) {
  //Here we will remove the consensus sequence, ALEXEY
  ...
  // count the occurrences of the chars at a position, and we remove consensus by slice(1)
  // but we need to do it only if we are displaying seqlogo - assuming that when we display seqlogo
  // we always have a consensus line , ALEXEY
  console.log(window.seqlogoflag);//ALEXEY
  if(window.seqlogoflag==true) {var seqs=this.seqs.slice(1)}//ALEXEY
  else {var seqs=this.seqs}//ALEXEY

  _.each(seqs, function(el) {
...
stat.prototype.conservResidue = function conservation(input) {
  ...
  var ic;
  //Here the logo is calculated, ALEXEY, let's try to kick away the first conensus row.
  var ignoredChars = this.ignoredChars;
  ...
  //We need to modify the frequency function, ALEXEY
  var f = this.frequency();
  var keys;
